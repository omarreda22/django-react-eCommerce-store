...
class Order(models.Model):
    ...
    paid_at = models.DateTimeField(auto_now=False, auto_now_add=False, blank=True, null=True)
    is_delivered = models.BooleanField(default=False)
    delivered_at = models.DateTimeField(auto_now=False, auto_now_add=False, blank=True, null=True)
...
class OrderItem(models.Model):
    ...
    produer = models.ForeignKey(Product, on_delete=models.CASCADE)
